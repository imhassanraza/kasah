                                                ...
                                                <tr class="odd gradeX">
                                                  <td width="20%" rowspan="4" align="center">
                                                      <div style="border:#999 solid 2px; width:75%; height:140px;">
                                                          <?php if (!empty($admin_details['avatar'])) { ?>
                                                          <img src="<?php echo base_url() ?>uploads/admin/<?php echo $admin_details['avatar'] ?>" style="width:100%; height:100%;" />
                                                          <?php } else{?>
                                                          <img src="<?php echo base_url() ?>assets/img/default_avatar.png" style="width:100%; height:100%;" />
                                                          <?php } ?>
                                                      </div></td>
                                                      <td width="25%">Full Name</td>
                                                      <td width="38%"><?php echo $admin_details['first_name']." ". $admin_details['last_name'] ?></td>
                                                      <td width="17%" align="right">
                                                        ...
                                                        <tr>
                                                            <td>Created Date</td>
                                                            <td><?php echo date('m-d-Y',strtotime($admin_details['created_date'])); ?></td>
                                                            <td>&nbsp;</td>
                                                        </tr>
                                                        <tr>
                                                                ...
                                                                <form action="<?php echo base_url() ?>admin/profile" method="post" accept-charset="utf-8" name="change_profile" class="form-horizontal" id="mws-validate">
                                                                    ...
                                                                    <div class="form-body">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <input type="text" name="first_name" id="first_name" value="<?php echo $admin_details['first_name'] ?>" class="form-control">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-body">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <input type="text" name="last_name" id="last_name" value="<?php echo $admin_details['last_name'] ?>" class="form-control">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-body">
