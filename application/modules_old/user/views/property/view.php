...
<div class="container slbgdiv view_block">
	...
	<div class="row rowb slptext1">
		...
		<div class="col-sm-4 askingpricediv">
			...
			<hr>
			<?php if ($detail['draft'] == "Y"){ ?>
			<p class="ppad1">
				<a href="<?php echo base_url() ?>user/property/publishApproval/<?php echo $detail['sell_id'] ?>" class="anchaoredit anchaor">Publish</a>
			</p>
			<p class="ppad1">
				<a href="<?php echo base_url() ?>user/property/edit/<?php echo $detail['sell_id'] ?>" class="anchaoredit-o anchaor">
					<i class="fa fa-edit" aria-hidden="true"></i>
					Edit Detail
				</a>
			</p>
			<?php }else if($detail['publish_approve'] == "Y"){ ?>
			<p class="ppad1">
				<span class="anchaoredit anchaor">
					Waiting for Approval
				</span>
			</p>
			<?php }else if($detail['is_approved'] == "Y"){ ?>
			<p class="ppad1">
				<span class="anchaoredit anchaor">
					Published
				</span>
			</p>
			<?php }else if($detail['is_sold'] == "Y"){ ?>
			<p class="ppad1">
				<span class="anchaoredit anchaor">
					Sold
				</span>
