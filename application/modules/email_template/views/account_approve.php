		...
		<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="mainContent">
			<tbody>
				<tr align="right">
					...
					<span style="    border-bottom: 3px solid #d41e34;padding-bottom: 6px;">Account Approved</span>
				</td>
			</tr>
			<tr>
				<td height="20"></td>
					...
					<tr>
						<td class="new-text" style="font-family:Franklin Gothic; font-size:15px;color:#000;padding: 0em 1.7em;line-height:1.9em;">
							<p>
								...
								<br>
								You can now login to your account by clicking a link below.
							</p>
							<div class="col-lg-3 pull-right buy-block" style="margin-bottom: 10px">
								<a href="<?php echo base_url() ?>login" target="_blank" class="anchaoredit">Click Here</a>
							</div>
						</td>
					</tr>
					<tr>
