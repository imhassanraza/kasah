...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Kasah - Administrator</title>
    ...
    <body class=" login">
        <!-- BEGIN LOGO -->
        <div class="logo">
            <a href="index.html" class="logopaddingtop">
				<img src="<?php echo base_url() ?>assets/img/logo.png" width="350px">
			</a>
		</div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
...
<!--                    <label class="rememberme check mt-checkbox mt-checkbox-outline">
		...
		<div class="copyright"> <?php echo date("Y"); ?>© Kasah </div>
		<!--[if lt IE 9]>
